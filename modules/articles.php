...
/*        $article['isPeer'] = count($article['versions']) > 0
    ...
    /**
         ...
         */
        public
        static function save($cols, $files = array())
        {
            global $PPHP;
            $db = $PPHP['db'];
            $config = $PPHP['config'];
         ...
         */
        public
        static function saveVersion($articleId, $files, $ver = null)
        {
            global $PPHP;
            $db = $PPHP['db'];
        ...
        {
            if (empty($reviewStates) || empty($articleStates)) {
                return []; // or throw an exception or log it
            }
